...
import static com.android.customization.model.ResourceConstants.OVERLAY_CATEGORY_UISTYLE;
...
public class DefaultThemeProvider extends ResourcesApkProvider implements ThemeBundleProvider {
    ...
    private static final String UISTYLE_PREFIX = "theme_overlay_style_";
    ...
    private void loadAll() {
        ...
        for (String themeName : themeNames) {
            ...
            try {
                String uiStyleOverlayPackage = getOverlayPackage(UISTYLE_PREFIX, themeName);
                mOverlayProvider.addUiStyleOverlay(builder, uiStyleOverlayPackage);
            } catch (NameNotFoundException | NotFoundException e) {
                Log.d(TAG, "Didn't find UI style overlay for theme, will use system default");
    ...
    private void addDefaultTheme() {
        ...
        try {
            String uiStyleOverlayPackage = getOverlayPackage(UISTYLE_PREFIX, DEFAULT_THEME_NAME);
            mOverlayProvider.addUiStyleOverlay(builder, uiStyleOverlayPackage);
        } catch (NameNotFoundException | NotFoundException e) {
    ...
    private void convertJsonToBuilder(JSONObject theme, ThemeBundle.Builder builder)
        ...
        mOverlayProvider.addUiStyleOverlay(builder,
                customPackages.get(OVERLAY_CATEGORY_UISTYLE));
